...
"[project]/src/actions/chat.ts [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/actions/chat.ts'\n\nExpression expected");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/actions/chat.ts [app-client] (ecmascript)");
...
function ChatDashboard({ userStage, scenarioId, scenarioContext, isPractice = false }) {
    ...
    const handleSendMessage = async (e)=>{
        ...
        setIsTyping(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAiResponse"])({
                message: userMsg,
                lifeStage: userStage,
...
//# sourceMappingURL=src_ad6227ec._.js.map