...
"[project]/src/actions/data:ec37fd [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$ec37fd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/actions/data:ec37fd [app-ssr] (ecmascript) <text/javascript>");
...
function ChatDashboard({ userStage, scenarioId, scenarioContext, isPractice = false }) {
    ...
    const handleSendMessage = async (e)=>{
        ...
        setIsTyping(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$ec37fd__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAiResponse"])({
                message: userMsg,
                lifeStage: userStage,
...
//# sourceMappingURL=src_a7bbd6f0._.js.map